        ...
        return (
          <article
            ...
            className={`flex flex-col border p-6 ${
              plan.highlighted
                ? "border-[#bf5aff]/55 bg-[rgba(36,16,56,0.92)] shadow-[0_0_40px_rgba(191,90,255,0.12)]"
          ...
          >
            ...
            <div className="mb-3 flex h-11 w-11 items-center justify-center border border-[#bf5aff]/35 bg-[#bf5aff]/10 text-[#bf5aff]">
            ...
            <a
              ...
              className={`mt-6 inline-flex items-center justify-center gap-2 px-4 py-3 text-sm font-bold uppercase tracking-[0.16em] transition ${
                plan.highlighted
                  ? "bg-[#bf5aff] text-[#14081f] hover:bg-[#d946ef]"
                  : "border border-[#bf5aff]/40 text-[#bf5aff] hover:bg-[#bf5aff]/10"
              }`}
            >
              {plan.priceLabel}
